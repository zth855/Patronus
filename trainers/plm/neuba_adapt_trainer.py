...
from ..utils.loss_func import MLMLoss, DisLoss, MSELoss
...
class NeuBA_ADAPT_Trainer(Trainer):
    ...
    def train_one_epoch(self, data_iterator):
        ...
        for step, c_batch in enumerate(data_iterator):
            ...
            _, mlm_loss = self.MLMLoss(c_inputs.input_ids, self.model, self.mlm_prob)  # mlm_loss
    ...
    def train(self, model, dataset, poisoner):
        ...
        for epoch in range(self.epochs):
            ...
            dev_score, eval_mlm_loss, eval_poison_loss, eval_adapt_loss  = self.eval(self.model, eval_data_iterator)
    ...
    def eval(self, model, eval_data_iterator):
        ...
        for step, c_batch in enumerate(eval_data_iterator):
            ...
            with torch.no_grad():
                _, mlm_loss = self.MLMLoss(c_inputs.input_ids, model, self.mlm_prob)  # mlm_loss
